...
// Fetch items from the database based on category
$query = "SELECT * FROM menu_items WHERE category = 'chinese.php' AND name LIKE '%$searchTerm%'";
...
<div class="container-xxl pt-5 pb-3">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5">Chinese Food Items</h1>
        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item text-center rounded overflow-hidden">
                        <div class="overflow-hidden m-4">
                            <img class="img-fluid" src="img/menu/<?php echo htmlspecialchars($item['image']); ?>" alt="">
                        </div>
                        <h5 class="mb-0"><?php echo htmlspecialchars($item['name']); ?></h5>
                        <small><?php echo htmlspecialchars($item['description']); ?> <br> LKR <?php echo htmlspecialchars($item['price']); ?></small>
