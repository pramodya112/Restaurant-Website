        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Sri Lankan Food Items</h1>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class=" overflow-hidden m-4">
                                <img class="img-fluid" src="img/menu/stringhoppers-3.jpg" alt="">
                            </div>
                            <h5 class="mb-0">King Coconut Water</h5>
                            <small>Freshly served from the orange-husked king coconut, known for its refreshing and hydrating properties. <br> LKR 450</small>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item text-center rounded overflow-hidden">
                            ...
                            <h5 class="mb-0">Ceylon Tea</h5>
                            <small>Renowned Sri Lankan tea, served hot or iced, available in various flavors such as black, green, or flavored with spices. <br>
                            Price: LKR 350 each</small>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item text-center rounded overflow-hidden">
                            ...
                            <h5 class="mb-0">Pol Roti</h5>
                            <small>Coconut flatbread served with lunu miris <br>
                            LKR 200</small>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item text-center rounded overflow-hidden">
                            ...
                            <h5 class="mb-0">Milk Rice (Kiribath)</h5>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item text-center rounded overflow-hidden">
                            ...
                            <smallCooked >In a rich meat stock with cardamom, cloves, and cinnamon, giving it a deep, aromatic flavor.
                                LKR 850</small>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item text-center rounded overflow-hidden">
                            ...
                            <small>With coconut milk and curry <br> LKR 300
                            </small>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item text-center rounded overflow-hidden">
                            ...
                            <small>Traditional coconut custard pudding <br>LKR 450
                            </small>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item text-center rounded overflow-hidden">
                            <div class=" overflow-hidden m-4">
                                <img class="img-fluid" src="img/menu/pudding.jpg" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item text-center rounded overflow-hidden">
                            ...
                            <small>Creamy mango dessert <br>LKR 850
                            </small>
                        </div>
                    </div>
