...
if (!$result) {
    die("Error executing query: " . $conn->error); // Show error if query fails
}
...
<div class="container-xxl py-5 bg-dark hero-header mb-5">
    ...
    <div class="col-lg-6">
        <div class="d-flex align-items-center">
            <img class="flex-shrink-0 img-fluid rounded" src="img/promotion/<?php echo htmlspecialchars($row['image']); ?>" alt="" style="width: 80px;">
            <div class="w-100 d-flex flex-column text-start ps-4">
                <h5 class="d-flex justify-content-between border-bottom pb-2">
                    <span><?php echo htmlspecialchars($row['title']); ?></span>
                    <span class="text-primary">LKR <?php echo htmlspecialchars($row['price']); ?></span>
                </h5>
